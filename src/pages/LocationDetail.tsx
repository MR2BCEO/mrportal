...
import { ArrowLeft, Box, ClipboardCheck, FileSpreadsheet } from "lucide-react";
...
export default function LocationDetail() {
  ...
  const fetchData = () => {
    supabase.from("locations").select("*, customers(name, id)").eq("id", id!).single().then(({ data }) => setLocation(data));
